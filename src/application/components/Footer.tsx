    ...
    <footer className="bg-gray-800 text-white py-6 w-screen">
        <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center">
            ...
            <div className="flex gap-4">
                <a href="https://github.com/slaterwebdev" aria-label="Github" className="hover:text-cyan-400">
                    <FaGithub size={24} />
                </a>
                <a href="https://linkedin.com" aria-label="LinkedIn" className="hover:text-cyan-400">
                    <FaLinkedin size={24} />
                </a>
            </div>
        </div>
